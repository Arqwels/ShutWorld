...
import { ADMIN_ADD_ARTIFACT, ADMIN_ADD_RANK, ADMIN_EDIT_ARTIFACT, ADMIN_EDIT_RANKS } from '../utils/consts';
  ...
  return (
      <WrapperComponent>
          ...
          <ul className={st.listUrls}>
            ...
            <li><Link to={ADMIN_EDIT_ARTIFACT} className={st.buttonAdminPage}>Изменить Артефакты!</Link></li>
          </ul>
      </WrapperComponent>
  )
}
